		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<!-- <img src="../assets/img/smkn.png" alt="navbar brand" class="navbar-brand" width="40"> -->
					<b class="text-white">SMKN 3 BATAM</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi SMKN 3 BATAM (<a href="index.php">Abid Taufiqur Rohman </a> | 2021)
					</div>				
				</div>
			</footer>
		</div>
